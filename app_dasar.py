...
st.title("Aplikasi AI untuk Hitung Surat Suara")
...
if uploaded_file:
    ...
    with st.spinner("Proses sedang berjalan..."):
        response_1 = model.generate_content(['''Anda adalah AI expert yang paham data pemilu,
        ...
        visualasi dengan st.plotly_chart(fig) dengan (warna red,gred, blue))',
        generate hanya code'''
